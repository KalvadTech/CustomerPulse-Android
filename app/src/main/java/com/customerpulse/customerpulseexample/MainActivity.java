...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enPageButton.setOnClickListener(v -> {
            ...
            params.put("lang", "en");
            CustomerPulseSurvey.showSurveyPage(this, "com.kalvad.example", "B", params,false, 3000);
        });
        Button arPageButton = findViewById(R.id.ar_page);
        arPageButton.setOnClickListener(v -> {
            HashMap<String, String> params = new HashMap<>();
            params.put("lang", "ar");
            CustomerPulseSurvey.showSurveyPage(this, "com.kalvad.example", "B", params, 3000);
        });
        Button arBottomSheetButton = findViewById(R.id.ar_bottom_sheet);
        arBottomSheetButton.setOnClickListener(v -> {
            HashMap<String, String> params = new HashMap<>();
            params.put("lang", "ar");
            CustomerPulseSurvey.showSurveyBottomSheet(this, "com.kalvad.example", "B", params,false, 3000);
        });
        ...
        arDismissibleBottomSheetButton.setOnClickListener(v -> {
            HashMap<String, String> params = new HashMap<>();
            params.put("lang", "ar");
            CustomerPulseSurvey.showSurveyBottomSheet(this, "com.kalvad.example", "B", params,true, 3000);
        });
